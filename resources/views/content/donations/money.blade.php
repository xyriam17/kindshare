  ...
  <div class="col-xxl-4 col-md-4 col-6">
    <div class="card h-100">
      <div class="card-body">
        ...
        <p class="text-heading mb-3 mt-1">₱{{ $total_recieved }}</p>
  ...
  <div class="col-xxl-4 col-md-4 col-6">
    <div class="card h-100">
      <div class="card-body">
        ...
        <h5 class="card-title mb-1">Pending Payment</h5>
        <p class="text-heading mb-3 mt-1">₱{{ $total_pending }}</p>
      </div>
    </div>
  </div>
    ...
    <div class="col-xxl-4 col-md-4 col-6">
      <div class="card h-100">
        <div class="card-body">
          ...
          <h5 class="card-title mb-1">Failed Payment</h5>
          <p class="text-heading mb-3 mt-1">₱{{ $total_failed }}</p>
...
<div class="card">
  <div class="card-datatable table-responsive">
    <table class="datatables-money table">
