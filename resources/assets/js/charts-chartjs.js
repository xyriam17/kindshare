...
(function () {
  ...
  if (monetary) {
    const monetaryChartVar = new Chart(monetary, {
      type: 'polarArea',
      data: {
        labels: ['Balance Remaining', 'Asia', 'Europe', 'America', 'Antarctica', 'Australia'],
        datasets: [
          {
  ...
  const indkind = document.getElementById('indkind');
  if (indkind) {
    const indkindChartVar = new Chart(indkind, {
      type: 'polarArea',
      data: {
        labels: ['Balance Remaining', 'Asia', 'Europe', 'America', 'Antarctica', 'Australia'],
        datasets: [
  ...
  const inkindChart = document.getElementById('inkindChart');
  if (inkindChart) {
    const inkindChartVar = new Chart(inkindChart, {
      type: 'doughnut',
      data: {
        labels: ['Donation Drive 1', 'Donation Drive 2', 'Balance'],
        datasets: [
          {
            data: [10, 10, 80],
  ...
  const monetaryChart = document.getElementById('monetaryChart');
  if (monetaryChart) {
    const monetaryChartVar = new Chart(monetaryChart, {
      type: 'doughnut',
      data: {
        labels: ['Donation Drive 1', 'Donation Drive 2', 'Balance'],
        datasets: [
  ...
  if (foodChart) {
    const foodChartVar = new Chart(foodChart, {
      type: 'doughnut',
      data: {
        labels: ['Donation Drive 1', 'Donation Drive 2', 'Balance'],
        datasets: [
