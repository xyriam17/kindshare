      ...
      @if(isset($navbarFull))
        <div class="navbar-brand app-brand demo d-none d-xl-flex py-0 me-4">
          <a href="{{url('/')}}" class="app-brand-link">
            ...
            <span class="app-brand-text demo menu-text fw-bold">KindShare</span>
          </a>
                  ...
                  <li class="list-group-item list-group-item-action dropdown-notifications-item marked-as-read">
                    <div class="d-flex">
                      ...
                      <div class="flex-grow-1">
                        <h6 class="mb-1 small">Food is expiring soon</h6>
                        <small class="mb-1 d-block text-body">Can goods expering in 4 days</small>
                      </div>
          ...
          <li class="nav-item navbar-dropdown dropdown-user dropdown">
            <a class="nav-link dropdown-toggle hide-arrow p-0" href="javascript:void(0);" data-bs-toggle="dropdown">
              <div class="avatar avatar-online">
                <img src="{{ Auth::user() ? asset('uploads/images/').'/'.Auth::user()->profile_photo_path : asset('assets/img/avatars/1.png') }}" alt class="rounded-circle">
              </div>
            </a>
